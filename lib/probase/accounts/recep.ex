defmodule Probase.Accounts.Recep do
  use Ecto.Schema
  import Ecto.Changeset

  schema "tbl_users_acc" do
    field :auto_password, :string, default: "recep"
    field :email, :string
    field :first_name, :string
    field :last_name, :string
    field :password, :string
    field :status, :integer, default: 4
    # field :user_id, :string
    field :user_role, :string
    field :user_type, :integer

    belongs_to :user, Reports.Accounts.Recep, foreign_key: :user_id, type: :id
