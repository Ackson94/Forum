defmodule ProbaseWeb.NotifyController do
  ...
  plug(
    ...
    when action in [:check_announce, :announ_view, :previous_ann, :notify_uploads]
  )
  ...
  def check_announce(conn, _param),
    do: render(conn, "check_announce.html", announ: Notify.new_announcement())
  ...
  def previous_ann(conn, _params),
    do: render(conn, "previous_ann.html", prev: History.preve_announcement())
