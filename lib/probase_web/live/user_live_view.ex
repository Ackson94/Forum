defmodule ProbaseWeb.UserLiveView do
  ...
  def mount(_params, %{"chat" => chat, "current_user" => current_user, "user_name" => user_name,} = session, socket) do
    ...
    {:ok, socket |> assign(user_name: user_name, chat: chat, message: Chats.change_message(), current_user: current_user, users: Presence.list_presences(live_view_topic(chat.id)), username_colors: username_colors(chat))}
  end 
